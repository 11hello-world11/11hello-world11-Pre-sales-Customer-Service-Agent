...
export async function handleQuery(pool, args) {
    if (!args.sql) {
...
export async function handleExecute(pool, args) {
    if (!args.sql) {
        throw new McpError(ErrorCode.InvalidParams, 'SQL query is required');
    }
...
export async function handleListTables(pool) {
    try {
...
export async function handleDescribeTable(pool, args) {
    if (!args.table) {
...
export async function handleExplain(pool, args) {
    if (!args.sql) {
...
export async function handleShowStatement(pool, args) {
